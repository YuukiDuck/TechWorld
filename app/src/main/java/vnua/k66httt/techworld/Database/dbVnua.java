    ...
    //        sqLiteDatabase.execSQL("INSERT INTO TAIKHOAN VALUES(1,'admin','admin','Nguyễn Quý Đức','nqduc@gmail.com','0787613866','18 An Duong Vuong',10000,'admin')");
            ...
            sqLiteDatabase.execSQL("INSERT INTO SANPHAM VALUES(11,'Lenovo Legion 5 Pro',3199,3,'Laptop gaming với card đồ họa NVIDIA GeForce RTX 3060, chip Intel Core i7, màn hình 16 inch.','https://laptopaz.vn/media/product/120_2816_2816_e2e2e23.png',40,20)");
            sqLiteDatabase.execSQL("INSERT INTO SANPHAM VALUES(12,'Acer Predator Helios 300',2899,3,'Laptop gaming với card đồ họa NVIDIA GeForce RTX 3060, chip Intel Core i7, màn hình 15.6 inch.','https://laptopaz.vn/media/product/3313_',25,5)");
            sqLiteDatabase.execSQL("INSERT INTO SANPHAM VALUES(13,'Dell Alienware m15 R7',4299,3,'Laptop gaming cao cấp với card đồ họa NVIDIA GeForce RTX 3070, chip Intel Core i7, màn hình 15.6 inch.','https://laptopaz.vn/media/product/120_2538_laptopaz_dell_alienware_m15_r7_2022_1s.jpg',20,2)");
            sqLiteDatabase.execSQL("INSERT INTO SANPHAM VALUES(14,'Asus ROG Strix G15',2899,3,'Laptop gaming với card đồ họa NVIDIA GeForce GTX 1660 Ti, chip AMD Ryzen 7, màn hình 15.6 inch.','https://laptopaz.vn/media/product/120_2541_',50,15)");
            sqLiteDatabase.execSQL("INSERT INTO SANPHAM VALUES(15,'Asus ROG Zephyrus G14',3499,3,'Laptop gaming với card đồ họa NVIDIA GeForce RTX 3060, chip AMD Ryzen 9, màn hình 14 inch.','https://laptopaz.vn/media/product/120_3162_',30,8)");

            sqLiteDatabase.execSQL("INSERT INTO SANPHAM VALUES(16,'Sạc nhanh Apple 20W',55,4,'Sạc nhanh Apple 20W với thiết kế nhỏ gọn, tương thích với nhiều thiết bị Apple, hỗ trợ sạc nhanh.','https://cdn2.cellphones.com.vn/insecure/rs:fill:0:358/q:90/plain/https://cellphones.com.vn/media/catalog/product/g/r/group_117_1.png',50,10)");
            sqLiteDatabase.execSQL("INSERT INTO SANPHAM VALUES(17,'Kính cường lực Samsung Galaxy S23',30,4,'Kính cường lực bảo vệ màn hình Samsung Galaxy S23, chịu lực tốt, dễ dàng lắp đặt.','https://cdn2.cellphones.com.vn/insecure/rs:fill:0:358/q:90/plain/https://cellphones.com.vn/media/catalog/product/0/3/03_2_6.jpg',30,5)");
            sqLiteDatabase.execSQL("INSERT INTO SANPHAM VALUES(18,'Ốp lưng iPhone 14',35,4,'Ốp lưng iPhone 14 bảo vệ thiết bị khỏi va đập, thiết kế mỏng nhẹ và thời trang.','https://cdn2.cellphones.com.vn/x/media/catalog/product/o/p/op-lung-iphone-14-plus-zagg.png',25,4)");
            sqLiteDatabase.execSQL("INSERT INTO SANPHAM VALUES(19,'Dây cáp USB-C Anker',20,4,'Dây cáp USB-C Anker với tốc độ truyền dữ liệu nhanh, bền bỉ và an toàn khi sử dụng.','https://cdn2.cellphones.com.vn/insecure/rs:fill:358:358/q:90/plain/https://cellphones.com.vn/media/catalog/product/c/a/cap-type-c-to-lightning-542-1-8m-tpe-bio-based-a80b2_1_.png',35,6)");
            sqLiteDatabase.execSQL("INSERT INTO SANPHAM VALUES(20,'Giá đỡ điện thoại đa năng',15,4,'Giá đỡ điện thoại đa năng giúp giữ điện thoại ở nhiều góc độ khác nhau, thuận tiện khi xem video hay gọi video.','https://cdn2.cellphones.com.vn/insecure/rs:fill:0:358/q:90/plain/https://cellphones.com.vn/media/catalog/product/g/i/gia-do-dien-thoai-hyperwork-t3_1_.png',40,7)");

            sqLiteDatabase.execSQL("INSERT INTO SANPHAM VALUES(21,'Lucky65',170,5,'Bàn phím cơ Lucky65 với layout 65%, switch hot-swappable, đèn RGB đa sắc, và vỏ nhôm chắc chắn.','https://bizweb.dktcdn.net/thumb/1024x1024/100/436/596/products/3-min-1713935782738.png?v=1713935789853',50,10)");
            sqLiteDatabase.execSQL("INSERT INTO SANPHAM VALUES(22,'Keydous NJ81',200,5,'Bàn phím cơ Keydous NJ81 với layout 75%, switch hot-swappable, hỗ trợ Bluetooth 5.0, và đèn RGB.','https://bizweb.dktcdn.net/thumb/1024x1024/100/436/596/products/kit-smoke-thep-1666453151415.jpg?v=1666453159877',30,5)");
            sqLiteDatabase.execSQL("INSERT INTO SANPHAM VALUES(23,'Bridge75',190,5,'Bàn phím cơ Bridge75 với layout 75%, switch hot-swappable, thiết kế đẹp mắt và đèn nền RGB.','https://bizweb.dktcdn.net/thumb/1024x1024/100/436/596/products/6-1714839203677.png?v=1714839391273',40,8)");
            sqLiteDatabase.execSQL("INSERT INTO SANPHAM VALUES(24,'Yunzii AL75',220,5,'Bàn phím cơ Yunzii AL75 với layout 75%, switch hot-swappable, hỗ trợ kết nối không dây và đèn RGB.','https://bizweb.dktcdn.net/thumb/1024x1024/100/436/596/products/10-1712134994791.png?v=1713008884050',25,3)");
            sqLiteDatabase.execSQL("INSERT INTO SANPHAM VALUES(25,'RAINY75',250,5,'Bàn phím cơ RAINY75 với layout 75%, switch hot-swappable, thiết kế chống nước và đèn RGB.','https://bizweb.dktcdn.net/thumb/1024x1024/100/436/596/products/22-min-1702460125985-1581efc5-d174-4c59-87b5-e582d9684396.png?v=1729429780613',20,1)");
