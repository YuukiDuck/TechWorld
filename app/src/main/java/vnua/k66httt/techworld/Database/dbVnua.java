...
//        sqLiteDatabase.execSQL("INSERT INTO TAIKHOAN VALUES(1,'admin','admin','Nguyễn Quý Đức','nqduc@gmail.com','0787613866','18 An Duong Vuong',10000,'admin')");
        ...
        sqLiteDatabase.execSQL("INSERT INTO DONHANG VALUES(1,2,'16/11/2023',100,'Đã nhận hàng',300)");
        sqLiteDatabase.execSQL("INSERT INTO DONHANG VALUES(2,5,'16/12/2023',200,'Đã nhận hàng',1000)");
        sqLiteDatabase.execSQL("INSERT INTO DONHANG VALUES(3,2,'17/09/2023',300,'Đã nhận hàng',200)");
        sqLiteDatabase.execSQL("INSERT INTO DONHANG VALUES(4,4,'18/01/2023',400,'Đã nhận hàng',10)");
        sqLiteDatabase.execSQL("INSERT INTO DONHANG VALUES(5,3,'19/11/2023',50,'Đã nhận hàng',20000)");
